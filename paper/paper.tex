...
%slide1 Finite-Time Lyapunov Exponent
\begin{equation}
...
%slide2 Standard Map
% One of the most popular mappings in the theory of Dynamical Systems is the so-called \textbf{standard map}, which was
